...
function CreateLocalizationInfo()
	...
	if Turbine.Engine.GetLanguage() == Turbine.Language.German then
		...
		Strings.PluginLoaded = "Geladen";
		Strings.PluginUnactivated = "Deaktiviert";
		------------------------------------------------------------------------------------------
		-- help --
		------------------------------------------------------------------------------------------
		Strings.PluginHelp1 = "\n\nListe der Befehle:\n";
...
elseif Turbine.Engine.GetLanguage() == Turbine.Language.French then
		...
		Strings.PluginLoaded = "charg\195\169";
		Strings.PluginUnactivated = "D\195\169sactiv\195\169";
		------------------------------------------------------------------------------------------
		-- help --
		------------------------------------------------------------------------------------------
		Strings.PluginHelp1 = "\n\nListe des commandes:\n";
...
elseif Turbine.Engine.GetLanguage() == Turbine.Language.English then
		...
		Strings.PluginLoaded = "loaded";
		Strings.PluginUnactivated = "Unloaded";
		------------------------------------------------------------------------------------------
		-- help --
		------------------------------------------------------------------------------------------
